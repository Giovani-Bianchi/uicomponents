        ...
        <Main>
            ...
            <section id="library-section">
                <Container>
                    ...
                    {/* Title & Subtitle */}
                    <LibTitleSubtitle>
                        <LibTitleH1>Checkboxes</LibTitleH1>
                        <LibText>Browse all the checkboxes in our components library.</LibText>
                    </LibTitleSubtitle>
                    ...
                    <LibContainer>
                        <LibRow>
                            ...
                            <ComponentContainer category="checkboxes" name="Checkbox">
...
// Exportando o componente Checkboxes
